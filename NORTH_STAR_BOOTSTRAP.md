...
This Bootstrap file is the **ignition key** for the North Star Framework Ecosystem — a comprehensive system for building production-ready software with AI assistance.
...
• Essential methodology (condensed)
...
### Primary: GitHub Raw URLs (Fetched On-Demand)

```
SCAFFOLDING FETCH URLS
─────────────────────────────────────────────────────────────────────────────
...
When starting a project with this Bootstrap, set up temporary scaffolding:

```
SCAFFOLDING SETUP — EXECUTE ON PROJECT START
─────────────────────────────────────────────────────────────────────────────

STEP 1: CREATE BUILD FOLDER
  mkdir -p ./build

STEP 2: FETCH FRAMEWORK DOCUMENTS
  
  Option A — If agent can fetch URLs:
    Fetch each URL above and save to ./build/
  
  Option B — If agent cannot fetch:
    Inform user: "Please download framework files from GitHub repo
    and place in ./build folder, or provide files directly."
...
IMPORTANT: The ./build folder is TEMPORARY SCAFFOLDING.
It will be removed when the project is complete.
See Section 8 for removal protocol.
```
...
│                   For Any Agent Receiving This Bootstrap                     │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  YOU HAVE RECEIVED:                                                          │
│  1. This North Star Bootstrap (ignition key)                                │
...
│       Sky — Standard quality, solid testing, essential docs                  │
│       Foundation — MVP quality, critical tests only, minimal docs            │
│                                                                              │
│  □ 4. BEGIN FIRST VERTICAL SLICE                                             │
│       Build ONE complete feature end-to-end                                  │
│       UI → API → Database → Tests → Working                                  │
│       Reference ./build/BRIDGE.md for navigation                            │
│                                                                              │
│  □ 5. REFERENCE FRAMEWORK ON DEMAND                                          │
│       Don't memorize everything — reference as needed                        │
│       Use BRIDGE.md to route to correct section                              │
│       Methodology questions → North Star Blueprint                           │
│       Technology questions → Master Build Framework                          │
│                                                                              │
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                              │
│  CRITICAL MINDSET:                                                           │
│  The framework is your REFERENCE, not your SCRIPT.                          │
│  Don't front-load everything. Build incrementally.                          │
